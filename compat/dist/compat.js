...
((a.prototype = new n.Component()).isPureReactComponent = !0),
	(a.prototype.shouldComponentUpdate = function (n, t) {
	...
	return (
		n &&
			(n.__c &&
				...
				(n.__c.__H = null)),
			null != (n = e({}, n)).__c &&
				(n.__c.__P === r && (n.__c.__P = t), (n.__c.__e = !0), (n.__c = null)),
			(n.__k =
				n.__k &&
...
function w(t) {
	...
	n.render(n.createElement(R, { context: e.context }, t.__v), e.h);
}
function j(t, e) {
	var r = n.createElement(w, { __v: t, p: e });
	...
	'string' == typeof t.type &&
		(function (t) {
			...
			'select' == r &&
				...
				e.class && !e.className
					? ((u.class = e.class), Object.defineProperty(u, 'className', z))
...
Object.defineProperty(exports, 'Component', {
	...
	(exports.createFactory = Y),
	(exports.createPortal = j),
	(exports.default = un),
	(exports.findDOMNode = X),
	(exports.flushSync = tn),
	(exports.forwardRef = v),
	(exports.hydrate = L),
	(exports.isElement = rn),
	(exports.isFragment = G),
	(exports.isMemo = J),
	...
	(exports.useDeferredValue = c),
	(exports.useInsertionEffect = f),
	(exports.useSyncExternalStore = u),
	(exports.useTransition = l),
