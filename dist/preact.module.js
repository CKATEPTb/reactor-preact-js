...
function I(n, l, u, t, i, r, o, e, f, c, s) {
	...
	for (f = P(u, l, _, f, m), a = 0; a < m; a++)
		null != (v = u.__k[a]) &&
			((h = -1 == v.__i ? p : _[v.__i] || p),
			(v.__i = a),
			(g = O(n, v, h, i, r, o, e, f, c, s)),
			(w = v.__e),
			v.ref &&
				h.ref != v.ref &&
				(h.ref && q(h.ref, null, v), s.push(v.ref, v.__c || w, v)),
			null == d && null != w && (d = w),
			4 & v.__u || h.__k === v.__k
				? (f = A(v, f, n))
...
function V(u, t, i, r, o, e, f, c, s) {
	...
	if (null == x) b === k || (c && u.data == k) || (u.data = k);
		...
		if (h)
			c ||
				(y && (h.__html == y.__html || h.__html == u.innerHTML)) ||
